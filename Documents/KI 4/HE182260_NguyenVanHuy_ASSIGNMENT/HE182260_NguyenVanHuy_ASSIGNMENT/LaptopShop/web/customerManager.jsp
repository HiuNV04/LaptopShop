...
<!--Nếu notFoundCustomer không là null => tìm đc cutsomer có tên match vs keyword
Nếu notFoundCustomer là null => ko tìm thấy customers nào cả
-->
        ...
        <div class="col-lg-12 table-responsive mb-5">
            <table class="table table-bordered text-center mb-0">
                ...
                <tbody class="align-middle">
                    <!-- lấy allCustomers từ servlet ManageCustomerController -->
