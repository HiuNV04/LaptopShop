        ...
        <div class="container-fluid mb-5">
            <div class="row border-top px-xl-5">
                ...
                <div class="col-lg-9">
                    ...
                    <!--Customer Manager-->
                    <!-- checks if the manageCustomer variable is not null.-->
                    <c:if test="${manageCustomer ne null}">

                        <!--checks if the allCustomers variable is not empty-->
                        <c:if test="${not empty allCustomers}">
                            <!--If both conditions are true, it includes (<include>) the content from customerManager.jsp file.
                            This means customerManager.jsp likely contains the UI or logic for managing customers.-->
