    ...
    <body>
        ...
        <script>
            function filterStatus(value) {
                /*
                 value ở đây là các id của từng status đc truyền vào
                 mình đã đặt id là all, wait, process,done
                 onchange="filterStatus(this.id) : filter dữ liệu theo id truyền vào
                 */
                // Hiển thị giá trị của checkbox được chọn trong console (optional)
                console.log(value);
...
//Nếu tham số service không tồn tại (null), đặt service bằng "filterStatus"=> display ra tất cả status
                if (service === null) {
                    service = "filterStatus";
                }
//Chuyển hướng trình duyệt đến URL mới với các tham số service và filter được gắn thêm vào URL.
